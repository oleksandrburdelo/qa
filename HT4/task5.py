...
# Seems like not origin text was used so I have update it.
# Looks good but all dots in the end of sentence were removed from result.

# Take a look on alterntive solution.
for sentence in re.findall("\S.*?[.!?](?=\s|$)", text):
    print(sentence)
    print()
